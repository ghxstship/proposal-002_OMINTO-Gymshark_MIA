...
<div class="version-banner">
  <div class="version-banner-inner">
    ...
    <div class="version-banner-text">You are viewing the <strong>Version 3.0</strong> snapshot &mdash; April 29, 2026. The canonical proposal lives at <code style="color:var(--iwc-gold)">/</code> and is currently identical; this URL will be preserved unchanged when future versions ship.</div>
