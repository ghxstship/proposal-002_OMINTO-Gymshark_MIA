...
<!-- VERSION BANNER (HISTORICAL) -->
<div class="version-banner">
  <div class="version-banner-inner">
    <div class="version-banner-tag">Historical Version</div>
    <div class="version-banner-text">You are viewing <strong>Version 1.0</strong> &mdash; April 17, 2026. This version has been superseded.</div>
  ...
  <div class="phase" data-a>
    ...
    <div class="phase-body">
      <div class="phase-inner" style="border-left:4px solid var(--white)">
        <p class="phase-narrative">
          Single-truck freight from the AGV Miami Bohemia, NY fabrication facility. Each activation includes a 2-person install crew, 1 on-site technician during operating hours, and same-day strike. Option 3 adds a climate-controlled warehouse hold and a repaint/rewrap window between activations.
        </p>
        ...
        <div class="core-item" style="border-color:var(--iwc-gold)">
          ...
          <div class="desc">Dedicated climate-controlled truck from the Miami strike site to the AGV Miami NYC staging facility for reskin, with real-time GPS tracking, two-driver rotation, and driver handoff documentation.</div></div>
...
<section id="locations" class="sec" style="padding-top:0">
  ...
  <div class="loc-city-section" data-a>
    <div class="loc-city-heading">
      ...
      <p>The client&rsquo;s named Miami candidates plus AGV Miami&rsquo;s recommended additions &mdash; from beachfront fitness culture to private luxury plazas and waterfront downtown parks.</p>
    </div>
...
<section id="schedule" class="sec" style="padding-top:0">
  ...
  <table class="sched-table" data-a>
    ...
    <tbody>
      ...
      <tr><td>Creative Lock</td><td>Final artwork, voucher template, IVR scripting, and packaging dielines delivered to AGV Miami</td><td>May 11</td></tr>
      ...
      <tr><td>Tech Bench Test</td><td>Full IVR + voucher printer + camera system rehearsed end-to-end at AGV Miami facility</td><td>June 19 &ndash; 23</td></tr>
      ...
      <tr><td>Strike &amp; Return Freight</td><td>Final de-installation and return transport to AGV Miami facility</td><td>July 11 &ndash; 13</td></tr>
  ...
  <div class="terms-grid" data-a>
    ...
    <div style="margin-top:40px" data-a>
      ...
      <table class="version-table">
        ...
        <tbody>
          <tr><td>1.0</td><td>April 17, 2026</td><td>AGV Miami</td><td>Initial proposal issued for Gymshark Phone Box NYC &amp; Miami July 2026 activation</td></tr>
        </tbody>
      </table>
    </div>
  </div>
